...
\label{sec:far-example-simple}

Let us reconsider the program from \Cref{fig:far-motivation}, reproduced in \Cref{fig:far-simple-reproduced}.
...
\begin{figure}
  ...
  \begin{singlespace}
    ...
    \makebox[\textwidth][c]{
      \begin{subfigure}[b]{0.4\paperwidth}
        \begin{gather*}
          [f\leftarrow[\varnothing]\lambda x.\{\hehole^{1:1}\},x\leftarrow[f\leftarrow[\varnothing]\lambda x.\{\hehole^{1:1}\}]\hehole^{2:1}]\hehole^{3:1} \\
          + \\
          [f\leftarrow[\varnothing]\lambda x.\{\hehole^1\},x\leftarrow[f\leftarrow[\varnothing]\lambda x.\{\hehole^{1:1}\}]\hehole^{2:1}]\hehole^{3:1}
        \end{gather*}
        \caption{Previous program result}
      \end{subfigure}
      \qquad
    ...
    \makebox[\textwidth][c]{
      \begin{subfigure}[b]{0.5\paperwidth}
        \begin{gather*}
          \llbracket f\leftarrow\llbracket\varnothing\rrbracket\lambda x.\{\hehole^{1:1}\},x\leftarrow\llbracket f\leftarrow\llbracket\varnothing\rrbracket\lambda x.\{\hehole^{1:1}\}\rrbracket\hhole{f\ 2}_1\rrbracket\hehole^{3:1} \\
          + \\
          \llbracket f\leftarrow\llbracket\varnothing\rrbracket\lambda x.\{\hehole^{1:1}\},x\leftarrow\llbracket f\leftarrow\llbracket\varnothing\rrbracket\lambda x.\{\hehole^{1:1}\}\rrbracket\hhole{f\ 2}_1\rrbracket\hehole^{3:1}
        \end{gather*}
        \caption{Preprocessed program result}
      ...
      \begin{subfigure}[b]{0.3\paperwidth}
        \begin{gather*}
          [f\leftarrow[\varnothing]\lambda x.\{\hehole^{1:1}\},x\leftarrow[x\leftarrow 1]^i\hehole^{1:1}]\hehole^{3:1} \\
          + \\
          [f\leftarrow[\varnothing]\lambda x.\{\hehole^{1:1}\},x\leftarrow[x\leftarrow 1]^i\hehole^{1:1}]\hehole^{3:1}
        \end{gather*}
        \caption{Resumed program result}
