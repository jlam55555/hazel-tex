...
\begin{figure}
  ...
  \begin{tikzpicture}
    ...
    \node[below=of hole31] (hole21) {$[\env^2]\hehole^{2:1}$};
    \node[below=of hole21] (hole11) {$[\varnothing]\hehole^{1:1}$};
    \node[right=of hole21] (hole12) {$[\varnothing]\hehole^{1:2}$};
    \node[right=of hole12] (hole13) {$[\varnothing]\hehole^{1:3}$};
    \node[above=of hole13] (hole22) {$[\env^2]\hehole^{2:2}$};
    \node[right=of hole22] (hole14) {$[\varnothing]\hehole^{1:4}$};

    \draw[->] (hole41) to[] node[right] {$c$} (hole31);
    \draw[->] (hole41) to[] node[below left] {$b$} (hole22);
    \draw[->] (hole41) to[] node[above right] {$a$} (hole14);
    \draw[->] (hole31) to[] node[right] {$b$} (hole21);
    \draw[->] (hole31) to[] node[above right] {$a$} (hole12);
    \draw[->] (hole22) to[] node[above right] {$a$} (hole13);
    \draw[->] (hole21) to[] node[above right] {$a$} (hole11);
  \end{tikzpicture}
