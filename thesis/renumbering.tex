...
We can combine the two postprocessing steps into a single pass. This essentially involves incorporating the hole numbering rules into the closure and hole rules for $\lambda$-conversion postprocessing. This is how the two postprocessing steps are implemented. For brevity and readability, a combined set of judgments is not described in this paper.
