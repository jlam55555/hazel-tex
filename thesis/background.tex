...
The static semantics of \gtlc{} is expectedly also similar to \stlc. The only rule that differs are the rules for function application.
...
\begin{singlespace}
  \begin{mathpar}
    \Infer{MatHoleArr}{}{\arrmatch{\tehole}{\tehole\to\tehole}}
    \and
    \Infer{MatArrArr}{}{\arrmatch{\tau_1\to\tau_2}{\tau_1\to\tau_2}}
  \end{mathpar}
\end{singlespace}
...
\begin{singlespace}
  \begin{mathpar}
    \Infer{TConsHoleTyp}{}{\tehole\sim\tau}
    \and
    \Infer{TConsTypHole}{}{\tau\sim\tehole}
    \and
    \Infer{TConsArr}{
      \tau_1\sim\tau_1' \\
      \tau_2\sim\tau_2'
