...
\begin{mathpar}
  \Infer{EvalB-Final}{E\vdash d\textsf{ final}}{\env\vdash d\Downarrow d}
  \and
  ...
  \and
  \Infer{EvalB-Op$_2$}{
    \env\vdash d_1\Downarrow\hnum{n_1} \\
    \env\vdash d_2\Downarrow\hnum{n_2}
  }{\env\vdash d_1+d_2\Downarrow\hnum{n_1+n_2}} \\
  \and
