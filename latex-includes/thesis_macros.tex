...
% structural diffing
\newcommand{\nodiff}[2]{#1\trianglerighteq #2}
\newcommand{\nfdiff}[2]{#1\triangleright #2}
\newcommand{\fdiff}[4]{#1\blacktriangleright_{#4}^{#3}#2}
\newcommand{\fnfdiff}[4]{#1\ntrianglerighteq_{#4}^{#3}#2}
\newcommand{\dff}[4]{#1\triangleright_{#4}^{#3}#2}
